...
//  teams-time
//
//  Created by Админ on 09/03/2023.
//
...
//        guard let mainVC = segue.destination as? MainStoryboard else { return }
//        mainVC.user = user
    }
    ...
    @IBAction func logInPressed() {
        ...
        performSegue(withIdentifier: "openMainVC", sender: nil) // надо идентификатор "openMainVC" прописать в сториборде
    }
